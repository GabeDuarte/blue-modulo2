...
function calcularDano() {
    if (!personagemSelecionado || !armaSelecionada) {
        alert('Selecione o personagem e/ou a arma para calcular o dano');
        return;
    }
    ...
    let resultado = 'Dano do ataque: ' + danoTotal + '! ';

    if (danoTotal >= vidaPersonagem) {
        resultado += 'Parabéns, você matou o(a) ' + personagemSelecionado;
    } else {
        resultado += 'Você não derotou o(a)  '+ personagemSelecionado+ ', tente novamente!';
    }
