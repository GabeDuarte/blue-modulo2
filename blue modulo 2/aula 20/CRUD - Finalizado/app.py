...
# Modelagem do banco de dados e definições das funções que serão utilizadas
...
# Página de Leitura de todos os registros do banco de dados
@app.route('/read')
def read_all():
    registros = Filmes.read_all()
    return render_template('read_all.html', registros = registros)

# Página de leitura de um registro do banco de dados
...
# Página para criar registros no banco de dados
...
# Página para atualizar registros do banco de dados
...
# Página para deletar registros do banco de dados
@app.route('/delete/<registro_id>')
def delete(registro_id):
    registro = Filmes.read_single(registro_id)
    return render_template('delete.html', registro = registro)

# Página de confirmação de remoção de registro do banco de dados
...
def delete_confirmed(registro_id):
    ...
    if registro:
        registro.delete()
        sucesso = True 
    return render_template('delete.html', sucesso = sucesso, registro = registro)
